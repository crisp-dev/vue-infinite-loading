...
}function mitt(n){return {all:n=n||new Map,on:function(t,e){var i=n.get(t);i?i.push(e):n.set(t,[e]);},off:function(t,e){var i=n.get(t);i&&(e?i.splice(i.indexOf(e)>>>0,1):n.set(t,[]));},emit:function(t,e){var i=n.get(t);i&&i.slice().map(function(n){n(e);}),(i=n.get("*"))&&i.slice().map(function(n){n(t,e);});}}}var SPINNERS = ['bubbles', 'circles', 'spiral', 'wavedots'];
...
function isVisible(elm) {
  ...
  return vue.pushScopeId("data-v-7b310c3a"), n = n(), vue.popScopeId(), n;
};
var _hoisted_1 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [_ctx.isShowSpinner ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 0,
  ...
  })], 4)) : vue.createCommentVNode("", true), _ctx.isShowNoResults ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 1,
    class: "infinite-status-prompt",
  ...
  })], 4)) : vue.createCommentVNode("", true), _ctx.isShowNoMore ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 2,
    class: "infinite-status-prompt",
  ...
  })], 4)) : vue.createCommentVNode("", true), _ctx.isShowError ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 3,
    class: "infinite-status-prompt",
...
script.__scopeId = "data-v-7b310c3a";// Import vue component
